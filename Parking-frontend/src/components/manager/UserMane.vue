...
<template>
  <div class="user-management">
    ...
    <el-row :gutter="20" class="search-area">
      ...
      <el-col :span="4">
        <el-button type="warning" icon="el-icon-edit" @click="feeUserShow = true">充值</el-button>
      </el-col>
    </el-row>
        ...
        <template slot-scope="scope">
          ...
          <span class="el-dropdown-link">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item icon="el-icon-edit" @click="toEdit(scope.row)">编辑</el-dropdown-item>
              <el-dropdown-item
